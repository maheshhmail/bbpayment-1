sap.ui.define([
	...
	"sap/ui/Device",
	"sap/bb/payserv/disbursements/model/models",
	"sap/bb/payserv/disbursements/controller/ErrorHandler"
], function(UIComponent, Device, models, ErrorHandler) {
	"use strict";

	return UIComponent.extend("sap.bb.payserv.disbursements.Component", {

		metadata: {
			"version": "1.0.0",
			"rootView": {
				"viewName": "sap.bb.payserv.disbursements.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
			...
			"config": {
				"i18nBundle": "sap.bb.payserv.disbursements.i18n.i18n",
			...
			"routing": {
				"config": {
					...
					"viewType": "XML",
					"viewPath": "sap.bb.payserv.disbursements.view",
					"controlId": "app",
